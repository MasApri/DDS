  ...
  <div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        ...
        {{ Form::open(array('action' => 'CkprController@upload', 'enctype' => "multipart/form-data", 'novalidate', 'class' => 'form-horizontal form-label-left' )) }}
          ...
          <div class="item form-group">
	        ...
	        <div class="item form-group">
		        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="ckpr">Pilih File
		        </label>
		        <div class="col-md-6 col-sm-6 col-xs-12">
		          <input id="ckpr" class="form-control col-md-7 col-xs-12" name="ckpr" type="file"">
		        </div>
		    </div>
              ...
              <div class="form-group">
                <div class="col-md-6 col-md-offset-3">
                  ...
                  <a href="<?php echo asset('public/csv/ckpr.csv') ?>" type="button" class="btn btn-success" style="float: right;">Download Template</a>
                </div>
              </div>
